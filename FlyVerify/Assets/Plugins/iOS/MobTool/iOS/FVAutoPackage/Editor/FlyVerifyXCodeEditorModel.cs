...
namespace cn.fv.unity3d.sdkporter
{
	public class FlyVerifyXCodeEditorModel
	{
		public string flyVerifyKey;
		...
		public FlyVerifyXCodeEditorModel()
		{
			flyVerifyKey = "";
			...
			if (dataSource.ContainsKey(dataKey))
			{
				...
				foreach (string value in tempArrayList)
				{
					...
					if (!comparisonFrameworks.Contains(filePath))
					{
						...
						FlyVerifyPathModel pathModel = new FlyVerifyPathModel();

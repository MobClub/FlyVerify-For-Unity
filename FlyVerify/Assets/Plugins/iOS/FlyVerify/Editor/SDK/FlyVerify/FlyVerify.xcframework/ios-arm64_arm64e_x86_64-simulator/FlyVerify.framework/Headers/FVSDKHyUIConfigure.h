//
//  FVSDKHyUIConfigure.h
//  FVSDKHyUIConfigure
//
//  Created by fly on 2020/11/13.
...
@class FVSDKHyPrivacyText;

@interface FVSDKHyUIConfigure : NSObject
 ...
 * 可通过[FVSDKHyVerify finishLoginVcAnimated:Completion:]手动关闭
 */
...
@property (nonatomic,strong) NSArray <FVSDKHyPrivacyText*> * privacySettings;
 ...
 * 拼接成完整隐私协议
 */
@interface FVSDKHyPrivacyText : NSObject
 ...
 * FVSDKHyPrivacyText * text_des_0 = [[FVSDKHyPrivacyText alloc]init];
 text_des_0.text = @"登录即代表同意";
 text_des_0.textColor = [UIColor randomColor];
 text_des_0.textFont = [UIFont systemFontOfSize:12];

 //运营商协议占位
 FVSDKHyPrivacyText * text_operator = [[FVSDKHyPrivacyText alloc]init];
 ...
 FVSDKHyPrivacyText * text_des_1 = [[FVSDKHyPrivacyText alloc]init];
 text_des_1.text = @"和";
 text_des_1.textColor = [UIColor randomColor];
 text_des_1.textFont = [UIFont systemFontOfSize:12];

 FVSDKHyPrivacyText * text_myPrivacy0 = [[FVSDKHyPrivacyText alloc]init];
 ...
 FVSDKHyPrivacyText * text_des_3 = [[FVSDKHyPrivacyText alloc]init];
